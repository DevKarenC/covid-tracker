...
const LinkedinIcon = () => {
  return (
    ...
    >
      <g className="scaling-icon" fillOpacity="1">
        <defs />
        <g
          className="bug-14dp"
          stroke="none"
